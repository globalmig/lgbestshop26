    ...
    <>
      <main className="min-h-[calc(100vh-44px)] bg-white text-black">
        ...
        <section className="border-t border-[#f1f1f1] bg-white">
          <div className="mx-auto grid h-[86px] max-w-[940px] grid-cols-1 px-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-[1080px] px-5">
            ...
            <div className="flex justify-center gap-6">
              {managers.map((m) => (
                <div key={m.name} className="flex w-[360px] flex-col items-center rounded-2xl bg-[#fdf3f5] px-10 py-10">
              ...
              {Array.from({ length: 10 }, (_, i) => (
                <a href="#" key={i} className="overflow-hidden rounded-lg">
                  <Image
                    ...
                    width={200}
                    height={150}
                    className="h-[130px] w-full object-cover transition-opacity hover:opacity-90"
                  />
                </a>
              ))}
            </div>
